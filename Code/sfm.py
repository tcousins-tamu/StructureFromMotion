...
class SFM(object):
    ...
    def _TriangulateTwoViews(self, name1, name2):
        ...
        new_point_cloud = __TriangulateTwoViews(
            img1pts, img2pts, R1, t1, R2, t2)
            ...
            while i < len(self.image_names):
                ...
                if curr_name in self.image_data.keys():
                    ...
                    pts3d = np.concatenate(
                        (pts3d, self.point_cloud[pts3d_idx.astype(int)]), axis=0)
    ...
    def Run(self):
        ...
        self.ToPly(os.path.join(self.out_cloud_dir,
...
def SetArguments(parser):
    ...
    parser.add_argument('--dataset', action='store', type=str, default='castle-P30', dest='dataset',
                        help='name of dataset (default: castle-P30)')
