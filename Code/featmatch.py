...
def FeatMatch(opts, data_files=[]):
    ...
    if len(data_files) == 0:
        img_names = sorted(os.listdir(opts.data_dirFt))
        img_paths = [os.path.join(opts.data_dirFt, x) for x in img_names if
    ...
    feat_out_dir = os.path.join(opts.out_dirFt, 'features', opts.features)
    matches_out_dir = os.path.join(opts.out_dirFt, 'matches', opts.matcher)
...
def SetArguments(parser):
    ...
    parser.add_argument('--data_dirFt', action='store', type=str, default="C:/Users/tcous/Desktop/school/CSCE748/project/Data/castle-P30/images",
    ...
    parser.add_argument('--ext', action='store', type=str, default='jpg,png', dest='ext',
                        ...
                        (default: jpg,png)')
    parser.add_argument('--out_dirFt', action='store', type=str, default='C:/Users/tcous/Desktop/school/CSCE748/project/Data/castle-P30/',
